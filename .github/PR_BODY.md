...
## 📝 Descrição
Integra tipos TypeScript do pacote de contratos OpenAPI no painel Admin-Web, permitindo type-safety nas chamadas de API e configurando flag USE_MOCKS para desenvolvimento local.
...
- [x] Flag USE_MOCKS configurada em Admin-Web
- [x] Admin-Web importa tipos do pacote contracts
...
- Bloqueia: TC-S2-ADM-07 a TC-S2-ADM-10 (todos consomem estes tipos).
- Issue: N/A.
